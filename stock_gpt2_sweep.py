...
def train():
    ...
    try: 
        ...
        subprocess.run(['python', 'train_stock.py', config_filename])
        run.finish()
...
def main():
    ...
    sweep_config = {
        ...
        'parameters': {
            ...
            'kan_hidden_size': {
                'values': [
                    768*3, 768*4, 768*5, 768*6, 768*7
                ]
            }
        }
    }
    sweep_id = wandb.sweep(sweep_config, project='alpaca-exp-gpt2-baseline')
